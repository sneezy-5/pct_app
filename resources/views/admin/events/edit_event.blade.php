    ...
    <section class="content">
        <div class="block-header">
              @if($errors)
                {{$errors}}
                @endif
            <h2>Editer un évènement</h2>
        </div>
        <div class="card">
           <form method="post" action="{{route('admin.event.update',['event'=>$event->id])}}">
            @csrf
            @method('put')
            <div class="body">
                <div class="demo-masked-input">
                    <div class="row clearfix">
                        <div class="col-md-12">
                            <b>Titre de l'evenement</b>
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="material-icons">perm_identity</i>
                                </span>
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="tapez quelque chose..." name="title" value="{{$event->title}}">
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" placeholder="description..." name="describe" value="{{$event->describe}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="date" class="form-control mobile-phone-number" placeholder="date de l'evenement" name="event_date" value="{{$event->event_date}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="file" class="form-control mobile-phone-number"  name="image" value="{{$event->image}}" >
                                </div>
                            </div>
                        </div>
