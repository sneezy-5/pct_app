                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="tapez quelque chose..." name="title"  >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="date" class="form-control mobile-phone-number" placeholder="date de l'evenement" name="event_date">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
