                                    ...
                                    <tbody>                                            
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{$project->describe}}</td>
                                              ...
                                              <td> <a class="btn btn-secondary" href="{{route('admin.project.edit',['project'=>$project->id])}}">Editer</a></td>
                                                <!-- <td> <a class="btn btn-primary" href="{{route('admin.project.show',['project'=>$project->id])}}">Afficher</a></td> -->
                                                <td>   <form  action="{{ route('admin.project.destroy', ['project'=>$project->id])}}" method="post"> 
                          @csrf 
                          @method('delete')
