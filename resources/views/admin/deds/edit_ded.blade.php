    ...
    <section class="content">
        <div class="block-header">
              @if($errors)
                {{$errors}}
                @endif
            <h2>Ajouter un décès</h2>
        </div>
        <div class="card">
           <form method="post" action="{{route('admin.ded.update',['ded'=>$ded->id])}}">
            @csrf
            @method('put')
            <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="tapez quelque chose..." name="ded_name" value="{{$ded->ded_name}}" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="date" class="form-control mobile-phone-number" placeholder="date de la naissance" name="ded_date" value="{{$ded->ded_date}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="file" class="form-control mobile-phone-number"  name="image" value="{{$ded->image}}" >
                                </div>
                            </div>
                        </div>
