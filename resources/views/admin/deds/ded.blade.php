...
<body class="theme-orange">
    ...
    <section class="content">
        ...
        <div class="card">
           <form method="post" action="{{route('admin.ded.store')}}">
            @csrf
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="tapez quelque chose..." name="ded_name" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="date" class="form-control mobile-phone-number" placeholder="date du décès" name="ded_date">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
