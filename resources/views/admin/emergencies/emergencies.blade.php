        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="{{route('admin.user.create')}}" class="menu-toggle">
                            <i class="material-icons">swap_calls</i>
                            <span>Utilisateur</span>
                        </a>
                        <ul class="ml-menu">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="DataTables_Table_0_length"><label>Liste <select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> haupital(ux)</label></div></div><div class="col-sm-6"><div id="DataTables_Table_0_filter" class="dataTables_filter"><label>Recherche:<input type="search" class="form-control input-sm" placeholder="" aria-controls="DataTables_Table_0"></label></div></div></div><div class="row"><div class="col-sm-12"><table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">

                                @if($emergencies->isEmpty())
                                    <p>Vous n'avez pas encore d'hopital enregistré</p>
                                @else
                                    <thead>
                                        <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 173px;">Nom</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 284px;">localisation</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 130px;">Téléphone</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 63px;">Adresse</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 122px;">Adresse</th></tr>
                                    </thead>
                                    <tfoot>
                                        <tr><th rowspan="1" colspan="1">Nom</th><th rowspan="1" colspan="1">localisation</th><th rowspan="1" colspan="1">Téléphone</th><th rowspan="1" colspan="1">Action</th>
                                    </tfoot>
                                    ...
                                    @foreach($emergencies as $emergency)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="sorting_1">{{$emergency->name}}</td>
                                            <td>{{$emergency->location}}</td>
                                            <td>{{$emergency->phone}}</td>
                                            <td>{{$emergency->adresse}}</td>
                      
                                              <td> <a class="btn btn-secondary" href="{{route('admin.emergency.edit',['emergency'=>$emergency->id])}}">Editer</a></td>
                                                <td> <a class="btn btn-primary" href="{{route('admin.emergency.show',['emergency'=>$emergency->id])}}">Afficher Service</a></td>
                                                <td> <a class="btn btn-primary" href="{{route('admin.sik.show',['sik'=>$emergency->id])}}">Afficher Maladie</a></td>
                                                <td>   <form  action="{{ route('admin.emergency.destroy', ['emergency'=>$emergency->id])}}" method="post"> 
                          @csrf 
                          @method('delete')
