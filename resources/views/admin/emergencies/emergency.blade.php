...
<body class="theme-orange">
    ...
    <section class="content">
        ...
        <div class="card">
           <form method="post" action="{{route('admin.emergency.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="Libelle" name="name">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" placeholder="Ex: Cocody" name="location">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control mobile-phone-number" placeholder="Ex: +00 (000) 000-00-00" name="phone">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control mobile-phone-number" placeholder="Ex: +00 (000) 000-00-00" name="adresse">
                                </div>
                            </div>
                        </div>   
