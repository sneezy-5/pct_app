    ...
    <section class="content">
        <div class="block-header">
              @if($errors)
                {{$errors}}
                @endif
            <h2>Editer un hopital</h2>
        </div>
        <div class="card">
           <form method="post" action="{{route('admin.emergency.update',['emergency'=>$emergency->id])}}" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="Libelle" name="name" value="{{$emergency->name}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" placeholder="Ex: Cocody" name="location" value="{{$emergency->location}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control mobile-phone-number" placeholder="Ex: +00 (000) 000-00-00" name="phone" value="{{$emergency->phone}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control mobile-phone-number" placeholder="Ex: +00 (000) 000-00-00" name="adresse" value="{{$emergency->adresse}}">
                                </div>
                            </div>
                        </div> 
