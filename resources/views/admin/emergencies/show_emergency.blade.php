                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <a class="btn btn-primary" href="{{route('admin.service.create_service',['id'=>$emergencies->id])}}">Ajouter</a>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                @else
                                    ...
                                    <tfoot>
                                        <tr><th rowspan="1" colspan="1">Nom</th><th rowspan="1" colspan="1">description</th><th rowspan="1" colspan="1">Action</th>
                                    </tfoot>
                                   
                                    <tbody>    
                                    @foreach($emergencies->services as $emergency)
                                        <tr role="row" class="odd">

                                            <td class="sorting_1">{{$emergency->name}}</td>
                                            <td>{{$emergency->describe}}</td>
                             
                                                <td>   <form  action="{{ route('admin.service.destroy', ['service'=>$emergency->id])}}" method="post"> 
                          @csrf 
                          @method('delete')
