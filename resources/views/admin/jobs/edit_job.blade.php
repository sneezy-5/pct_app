    ...
    <section class="content">
        <div class="block-header">
              @if($errors)
                {{$errors}}
                @endif
            <h2>Editer une profession</h2>
        </div>
        <div class="card">
           <form method="post" action="{{route('admin.job.update',['job'=>$job->id])}}">
            @csrf
             @method('put')
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="tapez quelque chose..." name="name" value="{{$job->name}}" >
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" placeholder="description..." name="describe" value="{{$job->describe}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" placeholder="Ex: Cocody..." name="describe" value="{{$job->location}}" >
                                </div>
                            </div>
                        </div>
