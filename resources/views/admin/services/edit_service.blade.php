                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="tapez quelque chose..." name="name" value="{{$service->name}}" >
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" placeholder="description..." name="describe" value="{{$service->describe}}" >
                                </div>
                            </div>
                        </div>
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" placeholder="Ex:(cocody)" name="lon" value="{{$service->lon}}" >
                                </div>
                            </div>
                        </div>
