                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <a class="btn btn-primary" href="{{route('admin.service.create_service')}}">Ajouter</a>
                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="DataTables_Table_0_length"><label>Liste <select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> servivee(s)</label></div></div><div class="col-sm-6"><div id="DataTables_Table_0_filter" class="dataTables_filter"><label>Recherche:<input type="search" class="form-control input-sm" placeholder="" aria-controls="DataTables_Table_0"></label></div></div></div><div class="row"><div class="col-sm-12"><table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                    ...
                                    <tbody>                                            
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{$service->lon}}</td>
                                            <td>{{$service->describr}}</td>
                      
                                              <td> <a class="btn btn-secondary" href="{{route('admin.service.edit',['service'=>$service->id])}}">Editer</a></td>
                                                <td> <a class="btn btn-primary" href="{{route('admin.service.show',['service'=>$service->id])}}">Afficher</a></td>
                                                <td>   <form  action="{{ route('admin.service.destroy', ['service'=>$service->id])}}" method="post"> 
                          @csrf 
                          @method('delete')
