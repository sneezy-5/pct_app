                                ...
                                @else
                                    ...
                                    <tbody>                                            
                                        <tr role="row" class="odd">
                                            ...
                                            <td> @if($pharmacy->is_active==1) de garde @else pas de garde @endif </td>
