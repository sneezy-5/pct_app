    ...
    <section class="content">
        <div class="block-header">
              @if($errors)
                {{$errors}}
                @endif
            <h2>Editer une pharmacie</h2>
        </div>
        <div class="card">
           <form method="post" action="{{route('admin.pharmacy.update',['pharmacy'=>$pharmacy->id])}}" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="tapez quelque chose..." name="name" value="{{$pharmacy->name}}" >
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" placeholder="description..." name="describe" value="{{$pharmacy->describe}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" placeholder="Ex: Cocody..." name="location" value="{{$pharmacy->location}}">
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="file" class="form-control mobile-phone-number"  name="image" value="{{$pharmacy->image}}">
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4">
                            <b>De garde</b>
                                    ...
                                    <select name="is_active" id="pet-select" class="">
