                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <a class="btn btn-primary" href="{{route('admin.sick.create_sick',['id'=>$emergencies->id])}}">Ajouter</a>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                @else
                                    ...
                                    <tbody>    
                                    @foreach($emergencies->siks as $emergency)
                                        <tr role="row" class="odd">

                                            <td class="sorting_1">{{$emergency->name}}</td>
                                            <td>{{$emergency->describe}}</td>
                             
                                                <td>   <form  action="{{ route('admin.sik.destroy', ['sik'=>$emergency->id])}}" method="post"> 
                          @csrf 
                          @method('delete')
