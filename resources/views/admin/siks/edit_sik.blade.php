...
<body class="theme-orange">
    ...
    <section class="content">
        ...
        <div class="card">
           <form method="post" action="{{route('admin.school.sik',['sik'=>$sik->id])}}">
            @csrf
            @mthod('put')
            <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="tapez quelque chose..." name="name" value="{{$sik->name}}" >
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" placeholder="description..." name="describe" value="{{$sik->describe}}" >
                                </div>
                            </div>
                        </div>
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" placeholder="Ex:(cocody)" name="lon" value="{{$sik->lon}}" >
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="file" class="form-control datetime"  name="image" >
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
