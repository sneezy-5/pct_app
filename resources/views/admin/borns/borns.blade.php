                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="DataTables_Table_0_length"><label>Liste <select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> personne(s)</label></div></div><div class="col-sm-6"><div id="DataTables_Table_0_filter" class="dataTables_filter"><label>Recherche:<input type="search" class="form-control input-sm" placeholder="" aria-controls="DataTables_Table_0"></label></div></div></div><div class="row"><div class="col-sm-12"><table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                    <thead>
                                        <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 173px;">Nom de la mere</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 284px;">Nom de l'enfant</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 130px;">date de l'acouchement</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 122px;">Action</th></tr>
                                    </thead>
                                    <tfoot>
                                        <tr><th rowspan="1" colspan="1">Nom de la mere</th><th rowspan="1" colspan="1">nom de l'enfant</th><th rowspan="1" colspan="1">date de l'acouchement</th><th rowspan="1" colspan="1">Action</th>
                                    </tfoot>
                                    <tbody>                                            
                                        <tr role="row" class="odd">
                                            @foreach($borns as $born)
                                            <td class="sorting_1">{{$born->mother_name}}</td>
                                            <td>{{$born->child_name}}</td>
                                            <td>{{$born->born_date}}</td>
                      
                                              <td> <a class="btn btn-secondary" href="{{route('admin.born.edit',['born'=>$born->id])}}">Editer</a></td>
                                                <!-- <td> <a class="btn btn-primary" href="{{route('admin.born.show',['born'=>$born->id])}}">Afficher</a></td> -->
                                                <td>   <form  action="{{ route('admin.born.destroy', ['born'=>$born->id])}}" method="post"> 
                          @csrf 
                          @method('delete')
