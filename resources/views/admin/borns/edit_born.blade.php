    ...
    <section class="content">
        <div class="block-header">
              @if($errors)
                {{$errors}}
                @endif
            <h2>Editer une Naissaince</h2>
        </div>
        <div class="card">
           <form method="post" action="{{route('admin.born.update',['born'=>$born->id])}}">
            @csrf
            @method('put')
            <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="tapez quelque chose..." name="mother_name" value="{{$born->mother_name}}" >
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" placeholder="nom de l'enfant" name="child_name" value="{{$born->child_name}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="date" class="form-control mobile-phone-number" placeholder="date de la naissance" name="born_date" value="{{$born->born_date}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="file" class="form-control mobile-phone-number"  name="image" value="{{$born->image}}" >
                                </div>
                            </div>
                        </div>
