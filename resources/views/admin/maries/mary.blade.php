...
<body class="theme-orange">
    ...
    <section class="content">
        ...
        <div class="card">
           <form method="post" action="{{route('admin.mary.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="tapez quelque chose..." name="mary_name"  >
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="date" class="form-control datetime"  name="mary_date" >
                                </div>
                            </div>
                        </div>
