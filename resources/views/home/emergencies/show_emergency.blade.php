						...
						<div class="row" id="page-contents">
							...
							<div class="col-lg-6">
								<div class="central-meta">
									<div class="groups">
										<span><i class="fa fa-users"></i> {{$emergency->name}}</span>
									</div>
									<ul class="nearby-contct">
                  <h4><a href="time-line.html" title="">Services</a></h4>
                  @foreach($emergency->services as $service)
										<li>
											<div class="nearly-pepls">
												...
												<div class="pepl-info">
													<h4><a href="time-line.html" title="">{{$service->name}}</a></h4>:
                        
                          
													<span>{{$service->lon}}</span>
                        
                          <em>{{$service->describe}}</em>
