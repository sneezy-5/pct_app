		...
		<div class="gap gray-bg">
			<div class="container-fluid">
				<div class="row">
                    ...
                    @foreach($degarde as $pharmacy)
										<li>
											<div class="nearly" >
												<figure>
													<a href="#" title=""><img src="/storage/image/{{$pharmacy->image}}" alt="" height="40" width="40"></a>
												</figure>
												<div class="pepl-info">
													<h4><a href="#" title="">{{$pharmacy->name}}</a></h4>
													<span>{{$pharmacy->location}}</span>
													<em style="background-color: greenyellow;"> @if($pharmacy->is_active==1) de garde @else  @endif</em>
													<p>{{$pharmacy->describe}}</p>
                    ...
                    @foreach($pharmacies as $pharmacy)
										<li>
											<div class="nearly-pepls">
												<figure>
													<a href="#" title=""><img src="/storage/image/{{$pharmacy->image}}" alt=""></a>
												</figure>
												<div class="pepl-info">
													<h4><a href="#" title="">{{$pharmacy->name}}</a></h4>
													<span>{{$pharmacy->location}}</span>
													<em> @if($pharmacy->is_active==1) de garde @else  @endif</em>
													<p>{{$pharmacy->describe}}</p>
													<!-- <a href="#" title="" class="add-butn" data-ripple="">Voir<span class="ripple"><span class="ink" style="height: 74px; width: 74px; background-color: rgb(255, 232, 8); top: -28.2px; left: -14.15px;"></span></span></a> -->
												</div>
											</div>
