						...
						<div class="row" id="page-contents">
							...
							<div class="col-lg-6">
								<div class="central-meta">
									<div class="groups">
										<span><i class="fa fa-users"></i> Mariages</span>
									</div>
                    ...
                    @foreach($maries as $mary)
										<li>
											<div class="nearly-pepls">
												<figure>
													<a href="time-line.html" title=""><img src="/storage/image/{{$mary->image}}" alt=""></a>
												</figure>
												<div class="pepl-info">
													<h4><a href="time-line.html" title="">{{$mary->name}}</a></h4>
													<span>{{$mary->image}}</span>
													<em>{{$mary->mary_date}}</em>
