	...
	<div class="topbar stick">
		...
		<div class="top-area">
			...
			<ul class="setting-area">
				...
				<li>
					<a href="#" title="Messages" data-ripple=""><i class="ti-comment"></i><span>{{$chatroom}}</span></a>
					<!-- <div class="dropdowns">
										...
										<ul class="activitiez">
											<li>
												<div class="activity-meta">
													<i>1h</i>
													<span><a href="#" title="">Poste vue  </a></span>
													<h6>par <a href="time-line.html">black demon.</a></h6>
												</div>
											</li>
											<li>
												<div class="activity-meta">
								...
								<div class="central-meta">
									<div class="new-postbox">
										...
										<form method="post" action="{{route('store')}}" enctype="multipart/form-data">
												@csrf
												<textarea rows="2" placeholder="Ecrivez quelque chose" name="title"></textarea>
									...
									<div class="user-post">
										<div class="friend-info">
											...
											<div class="friend-name">
												<ins><a href="time-line.html" title="">{{$actuality->user_name}}</a></ins>
												<span>published: {{$actuality->created_at}}</span>
											</div>
											<div class="post-meta">
									...
									<div class="widget">
										...
										<div class="your-page">
											...
											<div class="page-meta">
												...
												<span><i class="ti-comment"></i><a href="{{route('message.index')}}" title="">Messages <em></em></a></span>
										...
										<ul id="people-list" class="friendz-list">
											...
											<li>
												...
												<div class="friendz-meta">
													<a href="" id="{{$user->username}}" onclick="createOrReturnPrivateChat('{{$user->id}}')">{{$user->name}} </a>
