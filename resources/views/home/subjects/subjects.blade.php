							...
							<div class="col-lg-6">
								<div class="newpst-input">
										<form method="post" action="{{route('subject.store')}}" enctype="multipart/form-data">
												...
												<textarea rows="2" placeholder="Ecrivez quelque chose" name="describe"></textarea>
										...
										<li>
											<div class="nearly-pepls">
												...
												<h4><a href="#" title="" style="color:brown;">{{$subject->user_name}}</a></h4>
													...
													<em class="vote_{{$subject->id}}" >Vote:{{$subject->voted}}</em>
                    ...
                    @foreach($users as $user)
											<li>
												...
												<div class="friendz-meta">
													<a href="time-line.html">{{$user->name}} </a>
        ...
        'X-CSRF-TOKEN': '<?php echo csrf_token(); ?>'
			...
			$.ajax({
				...
				success: function(data) {
					...
					document.querySelector(vote_id).textContent='Vote:'+ data.response;
