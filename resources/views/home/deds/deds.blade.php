						...
						<div class="row" id="page-contents">
							...
							<div class="col-lg-6">
								<div class="central-meta">
									<div class="groups">
										<span><i class="fa fa-users"></i> Décès</span>
									</div>
                    ...
                    @foreach($deds as $ded)
										<li>
											<div class="nearly-pepls">
												<figure>
													<a href="time-line.html" title=""><img src="/storage/image/{{$ded->image}}" alt=""></a>
												</figure>
												<div class="pepl-info">
													<h4><a href="time-line.html" title="">{{$ded->ded_name}}</a></h4>
													<span>{{$ded->ded_date}}</span>
