                    ...
                    <ul class="naves">
							...
							<div class="col-lg-6">
								<div class="central-meta">
									<div class="groups">
										<span><i class="fa fa-users"></i> Projets Mairie</span>
									</div>
                    ...
                    @foreach($projects as $project)
										<li>
											<div class="nearly-pepls">
												<figure>
													<a href="time-line.html" title=""><img src="{{$project->image}}" alt=""></a>
												</figure>
												<div class="pepl-info">
													<h4><a href="time-line.html" title="">{{$project->name}}</a></h4>
													<span>centre publique</span>
													<em>{{$project->describe}}</em>
