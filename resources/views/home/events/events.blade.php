						...
						<div class="row" id="page-contents">
							...
							<div class="col-lg-6">
								<div class="central-meta">
									<div class="groups">
										<span><i class="fa fa-users"></i> Evenemment</span>
									</div>
                    ...
                    @foreach($events as $event)
										<li>
											<div class="nearly-pepls">
												<figure>
													<a href="time-line.html" title=""><img src="{{$event->image}}" alt=""></a>
												</figure>
												<div class="pepl-info">
													<h4><a href="time-line.html" title="">{{$event->title}}</a></h4>
													<span>centre publique</span>
													<em>{{$event->describe}}</em>
