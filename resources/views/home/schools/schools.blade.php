                    ...
                    <ul class="naves">
							...
							<div class="col-lg-6">
								<div class="central-meta">
									<div class="groups">
										<span><i class="fa fa-users"></i> Ecoles</span>
									</div>
                    ...
                    @foreach($schools as $school)
										<li>
											<div class="nearly-pepls">
												<figure>
													<a href="time-line.html" title=""><img src="{{$school->image}}" alt=""></a>
												</figure>
												<div class="pepl-info">
													<h4><a href="time-line.html" title="">{{$school->name}}</a></h4>
													<span><img src="{{asset('$school->image')}}" alt="" ></span>
